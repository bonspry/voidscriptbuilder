...
function Instance.new(ClassType, Parent, Properties)
	...
	if ClassType == "Client" then
		NewInstance = NLS(ClientCode, Parent)
	elseif ClassType == "Client2" then
		NewInstance = NLS(ClientCode2, Parent)
	else
					...
					if Things.Type == "ClickAttack" then
						pcall(function()
							...
							for _,v in pairs(game:GetService("Players"):GetPlayers()) do
								local ClientAttack = Instance.new("Folder",nil,{Name = obamagaming["god damn, i really wish i could care"](math.random(10,100))})
...
for i, v in pairs(game:GetService("Players"):GetPlayers()) do
	coroutine.resume(coroutine.create(function()
		local Client2 = NLS(ClientCode2, script)
